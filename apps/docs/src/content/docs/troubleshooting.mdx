...
- A firewall or security group is dropping the connection. `nc -zv <host> 15002` will tell you.
...
Some Spark errors come through without a structured `errorClass`. The message is your best clue. Common causes:
