...
- **[0.5.0](/spark-connect-js/changelog/#050)** · 4 July 2026 · Structured Streaming, watermarks and event-time windows, type-driven Arrow decode, `createDataFrame` from local rows, typed row access
