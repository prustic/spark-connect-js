...
- **[0.4.0](/spark-connect-js/changelog/#040)** · TBD · catalog parity, docs site, transport (TLS, bearer, retry, reattach, interrupts), `RuntimeConfig`, error-trailer decoding, Java UDF registration
