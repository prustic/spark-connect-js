...
Dated entries have shipped. Entries with no date are planned for the indicated release.
...
timeline TD
  ...
  0.4.0 · pending release : Documentation site
...
- **0.4.0** · feature-complete, pending release · catalog parity, docs site, transport (TLS, bearer, retry, reattach, interrupts), `RuntimeConfig`, error-trailer decoding, Java UDF registration
