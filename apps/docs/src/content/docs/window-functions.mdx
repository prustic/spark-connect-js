...
`rowsBetween(-3, 0)` means "three rows before me through me, inclusive". `rangeBetween(-1000, 0)` means "all rows whose ordering value is within 1000 below mine, through me".
